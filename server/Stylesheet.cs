...
namespace Maps.Rendering
{
    ...
    {
        public const string DEFAULT_FONT = "Arial,Liberation Sans";
        ...
        public Stylesheet(double scale, MapOptions options, Style style)
        {
            ...
            if (worlds.visible)
            {
                ...
                glyphFont = new FontInfo("Arial,Liberation Sans", scale < WorldFullMinScale ? 0.175f : 0.15f * fontScale, FontStyle.Bold);
